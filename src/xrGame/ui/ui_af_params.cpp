...
{
    "ui_inv_af_radiation_protection",
    "ui_inv_af_burn_protection", 
    "ui_inv_af_chemical_burn_protection", 
    "ui_inv_af_telepatic_protection", 
    "ui_inv_af_shock_protection",
	//OldSerpskiStalker
	//Фикс названия свойств, с outfit на af. Название свойства не соотв. параметру артефакта
    "ui_inv_af_wound_protection", 
    "ui_inv_af_fire_wound_protection", 
    "ui_inv_af_explosion_protection", 
    "ui_inv_af_strike_protection",	
};
