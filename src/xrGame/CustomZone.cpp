...
{
    //Лог спавна артефакта заблокировал
    //		Msg("BornArtefact[%s] prob %f cnt2 %f forced
    //%d",cName().c_str(),m_fArtefactSpawnProbability,(float)m_ArtefactSpawn.size(),forced );
